...
class CustomerController extends Controller
{
    ...
    public function create()
    {
       ...
       //dd($test);
        ...
        return view('office-staff.customer.create')->with('district', $district)->with('area',$area)->with('subcode',$subcode)->with('test',$test);
    }
    ...
    public function notifications()
    {
        ...
        return view('office-staff.customer.notification')->with('notification',$notification);
    }
    ...
    public function approve($id){
     //dd($id);
        ...
        //dd($approve);
        return view('office-staff.customer.approve')->with('approve',$approve); 
    }
    ...
    public function update_channel(Request $request ,$id){
     ...
     //dd($request->all());
        ...
        return view('office-staff.customer.customer_channel_invoice')->with('cus_channel',$cus_channel); 
