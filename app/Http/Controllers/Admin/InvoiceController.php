...
class InvoiceController extends Controller
{
    ...
    public function create()
    {
    	...
    	return view('admin.invoice.create')->with('customer',$customer);
    }
    ...
    public function invoice_reg(Request $request)
    {
      ...
      // dd($due_amount);
       ...
       //dd($total_amount);
    	...
    	return view('admin.invoice.invoice')->with('cust_package',$cust_package)->with('due_amount',$due_amount)->with('total_amount',$total_amount);
