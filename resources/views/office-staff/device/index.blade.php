                                       ...
                                       @endif
                                            ...
                                            <td>
                                               ...
                                               {{--  <button type="button" id="deletebtn"
                                                    ...
                                                    <a href="{{ route('devices.edit',$row->id) }}" class="btn btn-sm btn-clean btn-icon" title="Edit details">
                                <i class="la la-edit"></i>
                                </a>

                            
                                {{-- <a type="button" id="deletebtn" data-action="{{ route('devices.update',$row->id) }}" data-toggle="modal" data-target="#delete_modal" class="btn btn-sm btn-clean btn-icon" title="Delete">
                                <i class="la la-trash"></i>
                                </a>  --}}            


                                                 <button type="button" id="btnstatus" data-action="{{ route('devices.update',$row->id) }}" class="btn btn-primary badge " data-toggle="modal" data-target="#exampleModal">
                                                    Status
                                                </button>                
