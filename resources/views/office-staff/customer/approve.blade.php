...
<!--begin::Subheader-->
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <a href="{{ route('cus.notifications') }}"><button class="btn btn-primary" style="margin-left: 580px"> <i class="fas fa-undo"></i>Back</button></a>
    ...
    <div class="card card-custom gutter-b example example-compact">
        <div class="card-header">
			...
			<!--begin::Form-->
			<form class="form" action="{{ route('cus.notification_update',$approve->cust_id) }}" method="POST" enctype="multipart/form-data" >
			@csrf
			@method('put')
				<div class="card-body">
