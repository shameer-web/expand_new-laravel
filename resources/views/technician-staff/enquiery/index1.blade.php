                                      ...
                                      @foreach($data as $row)
									   ...
									   <td><span class="label label-danger label-inline mr-2">Not Assigned</span></td>
										  ...
										  @endif
                                            ...
                                            <td>
												<a href="{{ route('enq.edit',$row->id) }}" class="btn btn-outline-primary font-weight-bold mr-2"><i class="fa fa-edit"></i></a>


												<button type="button" id="deletebtn"
                                                              data-action="{{ route('enq.update',$row->id) }}" data-toggle="modal"
                                                              data-target="#delete_modal" class="btn btn-outline-danger"><i
                                                              class="fa fa-trash" aria-hidden="true"></i>
                                                             </button>
															 <button type="button" id="btnassign" data-action="{{ route('enq.update',$row->id) }}" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
													Assign
												</button>	
