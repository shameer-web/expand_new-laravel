...
<!--begin::Button-->
<a href="{{ route('enq.create') }}" class="btn btn-primary font-weight-bolder">
                        ...
                        <tbody>
                           ...
                           {{--  <td style="display:none">{{ $row->id }}</td> --}}
                            ...
                            <td>
                               ...
                               <a type="button" id="btnassign" data-action="{{ route('enq.update',$row->id) }}" data-toggle="modal" data-target="#exampleModal" class="btn btn-primary " title="Assign">
								{{-- <i class="la la-user"> --}} Actions</i>
								</a>


									{{-- <a href="{{ route('enq.edit',$row->id) }}" class="btn btn-sm btn-clean btn-icon" title="Edit details">
								<i class="la la-edit"></i>
								</a> --}}

							
								{{-- <a type="button" id="deletebtn" data-action="{{ route('enq.update',$row->id) }}" data-toggle="modal" data-target="#delete_modal" class="btn btn-sm btn-clean btn-icon" title="Delete">
