		...
		<table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
			...
			<tbody>
				...
				<tr>
					...
					<td>
					<a href="{{ route('customers.profile',$row->id) }}" class="btn btn-outline-warning font-weight-bold mr-2"><i class="fa fa-eye"></i></a>
					{{-- <a href="{{ route('cus.edit',$row->id) }}" class="btn btn-outline-primary font-weight-bold mr-2"><i class="fa fa-edit"></i></a> --}}
