                                      ...
                                      @foreach($type as $row)
				                        <tbody>
                          				 ...
                          				 <tr>
                                            ...
                                            <td>
												<a href="{{ route('type.edit',$row->id) }}" class="btn btn-outline-primary font-weight-bold mr-2"><i class="fa fa-edit"></i></a>


												<button type="button" id="deletebtn"
                                                              data-action="{{ route('type.update',$row->id) }}" data-toggle="modal"
