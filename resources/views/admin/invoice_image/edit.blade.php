...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
		...
		<!--begin::Subheader-->
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Invoice Logo | Edit Logo</h5>
						...
						<div class="card card-custom gutter-b example example-compact col-lg-6 mx-auto">
							...
							<div class="card-body">
							<!--begin::Form-->
							<form class="form" action="{{ route('invoice_image.update',$edit->id) }}" method="post" enctype="multipart/form-data">
								@csrf
								@method('put')
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" name="image" value="{{ $edit->invoice_image }}"  class="form-control" placeholder=""/>
