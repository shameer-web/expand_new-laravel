...
<!--end::Dropdown-->
 ...
 <!--begin::Button-->
									 {{-- <a href="{{ route('invoice_image.create') }}" class="btn btn-primary font-weight-bolder">
                          				 ...
                          				 <tr>
                                              ...
                                              <td>{{ $row->header }}</td>
                                               <td>
                                               	  ...
                                               	  <img src="{{ url('assets/image/invoice_image/'.$row->invoice_image)}}" alt="" width="60px" height="60px">
                                            ...
                                            <td>
												<a href="{{ route('invoice_image.edit',$row->id) }}" class="btn btn-outline-primary font-weight-bold mr-2"><i class="fa fa-edit"></i></a>


												{{-- <button type="button" id="deletebtn"
                                                              data-action="{{ route('invoice_image.update',$row->id) }}" data-toggle="modal"
                    ...
                    <form id="delete_form" action="" method="post" class="form-horizontal">
                        ...
                        <div class="modal-content">
                            <div class="alert alert-danger" role="alert" style="margin-bottom: 0px">
                                ...
                                <input type="hidden" name="invoice_image_status" value="0">
                            </div>
                        </div>
                    </form>
                </div>
