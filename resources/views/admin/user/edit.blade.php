								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="card card-custom gutter-b example example-compact">
											...
											<!--begin::Form-->
											<form class="form" action="{{ route('user.update',$edit->id) }}" method="post" enctype="multipart/form-data">
												@csrf
                                                @method('PUT')
												...
												<div class="card-body">
													...
													<div class="form-group row">
                                                        ...
                                                        <div class="col-lg-6">
																<label> state:</label>
															<input type="text" name="state" class="form-control" value="{{ $edit->state }}" />
														</div>
                                                   ...
                                                   <label>Roles:</label>
                                                  <select name="role" class="" id="kt_select2_3" placeholder=""   style="width: 100%" >
															 ...
															 <option value="{{ $edit->role }}">--Select Roles--</option>
