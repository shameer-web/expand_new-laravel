        ...
        <!--begin::Items-->
                <div class="d-flex align-items-center flex-wrap mt-8">
                    ...
                    {{--  <span class="mr-4">
                        ...
                        <div class="d-flex flex-column text-dark-75">
                            <span class="font-weight-bolder font-size-h5">Package Name</span>
                        ...
                        <div class="d-flex flex-column text-dark-75">
                            <span class="font-weight-bolder font-size-h5">Package Name</span>
                            <span class="font-weight-bolder font-size-sm"><span class="text-dark-50 font-weight-bold"></span>{{ $cust_package->package['package_name'] }}</span>
                        </div>
                        @endif
                    </div>
            <!--end::Item-->
            ...
            <!--begin::Item-->
                    ...
                    {{--  <span class="mr-3">
                        ...
                        <div class="d-flex flex-column text-dark-75">
                            <span class="font-weight-bolder font-size-h5">Package Amount</span>
                        ...
                        <div class="d-flex flex-column text-dark-75">
                            <span class="font-weight-bolder font-size-h5">Package Amount</span>
                            <span class="font-weight-bolder font-size-sm"><span class="text-dark-50 font-weight-bold"></span>{{ $cust_package->package['package_price'] }}</span>
                        </div>
                        @endif
                    </div>
            <!--end::Item-->
            ...
            <!--begin::Item-->
                        ...
                        {{--  <span class="mr-3">
                            ...
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-h5">Package Type</span>
                            ...
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-h5">Package Type</span>
                                <span class="font-weight-bolder font-size-sm"><span class="text-dark-50 font-weight-bold"></span>{{ $cust_package->package['package_type'] }}</span>
                            </div>
            ...
            <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                ...
                @if($cust_package == null)
                 ...
                 <div class="d-flex flex-column text-dark-75">
                    ...
                    <span class="font-weight-bolder font-size-sm"><span class="text-dark-50 font-weight-bold"></span>
        ...
        <div class="d-flex align-items-center flex-wrap mt-8">
            ...
            <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
               {{--  <span class="mr-3">
                ...
                <div class="d-flex flex-column text-dark-75">
                    <span class="font-weight-bolder font-size-h5">Device ID</span>
                    <span class="font-weight-bolder font-size-sm"><span class="text-dark-50 font-weight-bold"></span>{{ $cust_device->device_id }}</span>
                </div>
                @endif
            ...
            <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
               {{--  <span class="mr-3">
                ...
                @if($cust_device == null)
                 <div class="d-flex flex-column text-dark-75" style="display: none;">
                    <span class="font-weight-bolder font-size-h5">Device Name</span>
                    <span class="font-weight-bolder font-size-sm"><span class="text-dark-50 font-weight-bold"></span></span>
                </div>
                @else
                <div class="d-flex flex-column text-dark-75">
                    <span class="font-weight-bolder font-size-h5">Device Name</span>
                    <span class="font-weight-bolder font-size-sm"><span class="text-dark-50 font-weight-bold"></span>{{ $cust_device->device_name }}</span>
                </div>
                @endif
            ...
            <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
               {{--  <span class="mr-3">
                ...
                @if($cust_device == null)
                 <div class="d-flex flex-column text-dark-75" style="display: none;">
                    <span class="font-weight-bolder font-size-h5">Device Company</span>
                    <span class="font-weight-bolder font-size-sm"><span class="text-dark-50 font-weight-bold"></span></span>
                </div>
                @else
                <div class="d-flex flex-column text-dark-75">
                    <span class="font-weight-bolder font-size-h5">Device Company</span>
                    <span class="font-weight-bolder font-size-sm"><span class="text-dark-50 font-weight-bold"></span>{{ $cust_device->company_name }}</span>
                </div>
                @endif
            ...
            <!--end::Item-->
             ...
             <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
               {{--  <span class="mr-3">
                ...
                @else
                <div class="d-flex flex-column text-dark-75">
                    <span class="font-weight-bolder font-size-h5">Model </span>
                    <span class="font-weight-bolder font-size-sm"><span class="text-dark-50 font-weight-bold"></span>{{ $cust_device->model_name }}</span>
                </div>
                @endif
