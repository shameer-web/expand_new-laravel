...
<!--begin::Subheader-->
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5"> |  New Device Details </h5>
						...
						<div class="card card-custom gutter-b example example-compact">
							...
							<!--begin::Form-->
							<form class="form" action="{{ route('device.update',$device->id) }}" method="post">
								@csrf
								@method('put')
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-lg-3">
											<div class="input-group">
												  <input type="number" name='device_id' value="{{ $device->device_id }}" placeholder='Device ID' class="form-control" id="" />
											</div>
...
@section('script')
     ...
     <!--begin::Page Vendors(used by this page)-->
		...
		var device = "{{$device->device}}";
			$("#kt_select2_5").val(device);
			$("#kt_select2_5").trigger("change");

			var device = "{{$device->type}}";
			$("#kt_select2_4").val(device);
			$("#kt_select2_4").trigger("change");

			var device = "{{$device->model}}";
			$("#kt_select2_1").val(device);
			$("#kt_select2_1").trigger("change");

			var device = "{{$device->district}}";
			$("#kt_select2_2").val(device);
			$("#kt_select2_2").trigger("change");

			var device = "{{$device->lco_id}}";
			$("#kt_select2_3").val(device);
