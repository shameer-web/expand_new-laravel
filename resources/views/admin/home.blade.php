                                                ...
                                                <div class="card-spacer mt-n25">
                                                    ...
                                                    <div class="row m-0 mt-5">
                                                        ...
                                                        <div class="col bg-light-info px-6 py-8 rounded-xl">
                                                            ...
                                                            <a href="{{ route('customer.notifications') }}" class="text-success font-weight-bold font-size-h6 mt-2">Agent Notifications</a>
                                                    ...
                                                    <!--end::Row-->
                                                     ...
                                                     <!--begin::Row-->
                                                    <div class="row m-0 mt-5">
                                                        <div class="col-6 bg-light-info px-6 py-8 rounded-xl mr-7">
                                                            <span class="svg-icon svg-icon-3x svg-icon-danger d-block my-2">
                                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                            ...
                                                            <a href="{{ route('invoice.notifications') }}" class="text-danger font-weight-bold font-size-h6 mt-2">Office Staff Notifications</a>
