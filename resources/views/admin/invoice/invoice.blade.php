              ...
              <td class="center" colspan="2" width="100%"> 
                <div class="row">
                  ...
                  {{-- <div class="col-md-3">
                      ...
                      <form action="{{ route('gateway.payu') }}" method="post">
                        @csrf

                          <input type="hidden" name="amount" value="{{ $total_amount }}">
                         <button type="submit"  class="btn btn-primary font-weight-bolder py-4 mr-3 mr-sm-14 my-1 "   style="margin-left: 40px" > Online Payment</button>
 ...
 <div class="modal fade" id="onlinepayment" tabindex="-1" role="dialog"  aria-hidden="true">
         <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('gateway.payu',$cust_package->id) }}" method="post" >
                        @csrf
