                       ...
                       <div class="card card-custom gutter-b">
							<div class="card-header flex-wrap py-3">
								<div class="card-title">
									<h3 class="card-label">
										View All Office Staff Notifications
...
<!--begin::Button-->
									<a href="{{ route('admin.index') }}" class="btn btn-success font-weight-bolder">
									...
									<!--end::Button-->
										...
										<div class="card-body">
											...
											<table class="text-center table table-bordered table-checkable w-75" style="margin-left: 100px" id="kt_datatable">
												<thead>
													<tr>
														<th>Staff name</th>
														<th>Notifications</th>
												...
												<tbody>
													<tr>
														...
														<td>
															{{-- <button type="submit" class="badge btn btn-info">notifications</button> --}}

															<a href="{{ route('invoice.approve',$row->id) }}">
