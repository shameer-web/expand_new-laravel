...
<table class="table-bordered" style="width: 100%">
 ...
 <p>Phone:+1-647-354-1222, +1-437-772-3191</p> --}}
          ...
          <tr>
              ...
              @else
              <td class="center" width="50%"> 
               <h6>Plan Rate:  {{ $cust_package->package['package_price'] }}</h6>
              </td> 
              @endif                          
          </tr>
         ...
         {{--   <tr>
          ...
          <tr>
              ...
              @else
              <td class="center" width="50%"> 
               <h6> Previous Balance: {{ $approve->balance }}</h6>
              </td> 
              @endif 
              ...
              @else
              <td class="center" width="50%"> 
               <h6 class="text-danger font-weight-bold"> Discount: {{ $approve->discount }}</h6>
              </td>  
              @endif
          ...
          <tr>
              ...
              @else
              <td class="center" width="50%"> 
               <h6> Total Amount: {{ $approve->package_total_amount }} </h6>
              </td>  
              @endif  
              ...
              <td class="center" colspan="2" width="100%"> 
                <div class="row">
                   <div class="col-md-6">
                     ...
                     <form class="form" action="{{ route('invoice.notification_reject',$approve->id) }}" method="POST" enctype="multipart/form-data" >
                        @csrf
                        @method('put')

                          <button type="submit" class="btn btn-danger font-weight-bolder py-4 mr-3 mr-sm-14 my-1" data-toggle="" data-target="" >Reject</button>
                   ...
                   <div class="col-md-6">
                       ...
                       <form class="form" action="{{ route('invoice.notification_update',$approve->id) }}" method="POST" enctype="multipart/form-data" >
                        @csrf
                        @method('put')
                        <input type="hidden" name="package_amount" value="{{ $approve->package_amount }}">
                        <input type="hidden" name="package_total_amount" value="{{ $approve->package_total_amount }}">
                        <input type="hidden" name="balance" value="{{ $approve->balance }}">
                        <input type="hidden" name="discount" value="{{ $approve->discount }}">


                         <button type="submit" class="btn btn-primary font-weight-bolder py-4 mr-3 mr-sm-14 my-1" data-toggle="" data-target="" > Approve</button>
