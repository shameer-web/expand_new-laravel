...
<a href="{{ route('customer.notifications') }}" class="btn btn-success font-weight-bolder">
...
</svg></span>	Agent Notifications -> <span class="font-weight-bolder text-danger"> {{ $agent_notification }}</span>
</a>
</div>	
@endif		
                        ...
                        <tbody>
							...
							<tr>
								...
								<td>
									...
									<a href="{{ route('customer.profile',$row->id) }}" class="btn btn-sm btn-clean btn-icon" title="View details">
								<i class="la la-eye"></i>
								</a>

									<a href="{{ route('customer.edit',$row->id) }}" class="btn btn-sm btn-clean btn-icon" title="Edit details">
								<i class="la la-edit"></i>
								</a>

							
								<a type="button" id="deletebtn" data-action="{{ route('customer.update',$row->id) }}" data-toggle="modal" data-target="#delete_modal" class="btn btn-sm btn-clean btn-icon" title="Delete">
