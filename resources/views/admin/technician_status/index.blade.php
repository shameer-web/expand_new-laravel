...
<!--begin::Button-->
									<a href="{{ route('technician_status.create') }}" class="btn btn-primary font-weight-bolder">
									...
									<!--end::Button-->
                                      ...
                                      @foreach($technician_status as $row)
				                        <tbody>
                          				 ...
                          				 <tr>
                                              <td>{{ $row->id }}</td>
                                              <td>{{ $row->technician_status }}</td>
                                             
                                               
                                             
                                            <td>
												<a href="{{ route('technician_status.edit',$row->id) }}" class="btn btn-outline-primary font-weight-bold mr-2"><i class="fa fa-edit"></i></a>


												<button type="button" id="deletebtn"
                                                              data-action="{{ route('technician_status.update',$row->id) }}" data-toggle="modal"
