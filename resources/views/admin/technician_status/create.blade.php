		...
		<!--begin::Subheader-->
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Technician |  New Technician Status</h5>
						...
						<div class="card card-custom gutter-b example example-compact col-lg-6 mx-auto">
							<div class="card-header">
								<h3 class="card-title">
									  New Technician Status
								</h3>
								
							</div>
							<div class="card-body">
							<!--begin::Form-->
							<form class="form" action="{{ route('technician_status.store') }}" method="post">
								@csrf
