                                      ...
                                      @foreach($area as $row)
				                        <tbody>
                          				 ...
                          				 <tr>
                                            ...
                                            <td>
												<a href="{{ route('area.edit',$row->id) }}" class="btn btn-outline-primary font-weight-bold mr-2"><i class="fa fa-edit"></i></a>


												<button type="button" id="deletebtn"
                                                              data-action="{{ route('area.update',$row->id) }}" data-toggle="modal"
                    ...
                    <form id="delete_form" action="" method="post" class="form-horizontal">
                        ...
                        <div class="modal-content">
                            <div class="alert alert-danger" role="alert" style="margin-bottom: 0px">
                                ...
                                <input type="hidden" name="area_status" value="0">
                            </div>
                        </div>
                    </form>
                </div>
