...
<!--begin::Button-->
									<a href="{{ route('model.create') }}" class="btn btn-primary font-weight-bolder">
                                      ...
                                      @foreach($model as $row)
				                        <tbody>
                          				 ...
                          				 <tr>
                                            ...
                                            <td>
												<a href="{{ route('model.edit',$row->id) }}" class="btn btn-outline-primary font-weight-bold mr-2"><i class="fa fa-edit"></i></a>


												<button type="button" id="deletebtn"
                                                              data-action="{{ route('model.update',$row->id) }}" data-toggle="modal"
                    ...
                    <form id="delete_form" action="" method="post" class="form-horizontal">
                        ...
                        <div class="modal-content">
                            <div class="alert alert-danger" role="alert" style="margin-bottom: 0px">
                                ...
                                <input type="hidden" name="model_status" value="0">
                            </div>
                        </div>
                    </form>
                </div>
