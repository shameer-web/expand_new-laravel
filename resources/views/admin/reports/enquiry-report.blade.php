...
<div class="card card-custom card-custom  gutter-t">
    <div class="card-header py-3">
        <div class="card-title">
            <h3 class="card-label">Enquiry Report</h3>
        </div>
    ...
    <div class="card-body">
                                                ...
                                                <div class="m-form__control">
                                                    <select class="form-control m-bootstrap-select m-bootstrap-select--solid table_filter" id="table_filter_status">
                                                         <option value="all">All</option>
                                                            ...
                                                            <option value='1'>Compleeted</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="d-md-none m--margin-bottom-10"></div>
        ...
        <table class="table table-separate table-head-custom table-checkable" id="enquiry_view_table">
                                <thead>
                              <tr>
                                <th>Order ID</th>
                                <th>Enquiry No</th>
...
@include('admin.custome_scripts.enquiry_report_scripts');    
