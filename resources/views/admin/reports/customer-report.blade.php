...
<div class="card card-custom card-custom  gutter-t">
    <div class="card-header py-3">
        <div class="card-title">
            <h3 class="card-label">Customer Report</h3>
        </div>
    ...
    <div class="card-body">
        ...
        <table class="table table-separate table-head-custom table-checkable" id="customer_view_table">
                                <thead>
                              <tr>
                                <th>Order ID</th>
                                <th>Customer Name</th>
...
@include('admin.custome_scripts.customer_report_scripts');    
