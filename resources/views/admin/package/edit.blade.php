								...
								<div class="card-body">
									<div class="form-group row">
										...
										<div class="col-lg-3">
											...
											value="{{ $package->package_name }}"  class="form-control" placeholder="Enter full name"/>
									...
									<div class="form-group row">
										...
										<div class="col-lg-3">
											<div class="input-group">
												  <input type="text" id="package_price" name='package_price' value="{{ $package->package_price }}" placeholder='0.00' class="form-control" id="package_price" />
											</div>
										...
										<div class="col-lg-3">
											<div class="input-group">
												 ...
												 value="{{ $package->gst }}" class="form-control" id="gst" placeholder="0">
									...
									<div class="form-group row">
										...
										<div class=" col-lg-3">
											<div class="input-group">
												 <input type="text" name='total_amount' value="{{ $package->total_amount }}" id="total_amount1" placeholder='0.00' class="form-control" />
