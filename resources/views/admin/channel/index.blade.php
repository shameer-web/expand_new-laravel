...
<!--begin::Button-->
									<a href="{{ route('channel.create') }}" class="btn btn-primary font-weight-bolder">
									...
									<!--end::Button-->
									  ...
									  @foreach($channel as $row)
									   ...
									   <td><span class="label label-primary label-inline mr-2">Postpaid</span></td>
										  ...
										  @endif
                                              <td>{{ $row->channel_price}}</td>
                                              <td>{{ $row->channel_amount }}</td>
                                             {{--  <td>{{ $row->channel_amount }}</td> --}}
                                              <td>{{ $row->total_amount }}</td>
                                               
                                             
                                            <td>
												<a href="{{ route('channel.edit',$row->id) }}" class="btn btn-outline-primary font-weight-bold mr-2"><i class="fa fa-edit"></i></a>


												<button type="button" id="deletebtn"
                                                              data-action="{{ route('channel.update',$row->id) }}" data-toggle="modal"
                    ...
                    <form id="delete_form" action="" method="post" class="form-horizontal">
                        ...
                        <div class="modal-content">
                            <div class="alert alert-danger" role="alert" style="margin-bottom: 0px">
                                ...
                                <input type="hidden" name="channel_status" value="0">
                            </div>
                        </div>
                    </form>
                </div>
