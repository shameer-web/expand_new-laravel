                        ...
                        <tbody>
							...
							<tr>
								...
								<td>
									...
									<a href="{{ route('cust.profile',$row->id) }}" class="btn btn-sm btn-clean btn-icon" title="View details">
								<i class="la la-eye"></i>
								</a>

									<a href="{{ route('cust.edit',$row->id) }}" class="btn btn-sm btn-clean btn-icon" title="Edit details">
