...
<!--begin::Button-->
<a href="{{ route('cust.create') }}" class="btn btn-primary font-weight-bolder">
		...
		<table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
			<thead>
				<tr>
					...
					<th title="Field #2" >Customer ID</th>
					<th title="Field #3">Name</th>
					<th title="Field #4">Mobile</th>
					<th title="Field #5">Customer Type</th>
					<th title="Field #6">Post No</th>
					<th title="Field #7">Area</th>
			...
			<tbody>
				...
				<tr>
					...
					<td>
					<a href="{{ route('cust.profile',$row->id) }}" class="btn btn-outline-warning font-weight-bold mr-2"><i class="fa fa-eye"></i></a>
					<a href="{{ route('cust.edit',$row->id) }}" class="btn btn-outline-primary font-weight-bold mr-2"><i class="fa fa-edit"></i></a>
					<button type="button" id="deletebtn" data-action="{{ route('cust.update',$row->id) }}" data-toggle="modal" data-target="#delete_modal" class="btn btn-outline-danger"><i
